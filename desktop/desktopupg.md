...
- **Next:** manually dispatch `desktop-build.yml` to get first real compile/link proof on all 3 OSes before/alongside Phase 5, then commits 10–11 (xterm frontend + wiring).
