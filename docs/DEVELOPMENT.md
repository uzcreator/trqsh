...
| Node | **20+** (22/24 ok) | web dashboard + site, desktop app UI | `winget install OpenJS.NodeJS.LTS` |
...
| Rust | stable (**1.77+**) | desktop app (Tauri v2, `desktop/`); the Tauri CLI comes via `pnpm install` in `desktop/` | https://rustup.rs |
