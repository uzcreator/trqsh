...
// components/cursor-orbit.tsx drives this as a full-screen custom-cursor
// replacement (desktop/pointer:fine only). Ported from lightswind
// (registry/particle-orbit-effect.tsx) — canvas + rAF, no deps.
